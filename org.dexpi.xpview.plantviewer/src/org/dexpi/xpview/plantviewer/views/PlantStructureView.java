...
import org.dexpi.xpview.plantviewer.adapter.InstrumentAdapter;
import org.dexpi.xpview.plantviewer.adapter.InstrumentListAdapter;
...
public class PlantStructureView extends ViewPart implements EventListener, ISelectionListener {
	...
	public void createPartControl(Composite parent) {
		...
		factory.registerAdapter(new InstrumentListAdapter(), InstrumentList.class);
		factory.registerAdapter(new InstrumentAdapter(), Instrument.class);
